...
from mib.views.filters import delivery_datetime_format,datetime_format, delivery_datetime_field_format
class TestVIewsFilters:

    @pytest.mark.parametrize("date, fmt",[ 
        (datetime(2000, 2, 1),"00:00 01/02/2000"),
        (None,"")
    ])
    ...
    @pytest.mark.parametrize("date, fmt",[ 
        (datetime(2000, 2, 1),"2000-02-01T00:00"),
        (None,"")
    ])
