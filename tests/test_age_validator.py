...
class TestAgeValidator:
    ...
    @pytest.mark.parametrize("min_age,max_age, ex_msg",[ 
    ...
    @pytest.mark.parametrize("min_age,max_age,birthdate",[ 
    ...
    @pytest.mark.parametrize("min_age,max_age,birthdate,message",[ 
